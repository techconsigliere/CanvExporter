...
(function () {
  ...
  shadow.innerHTML =
    ...
    '<p class="d">Saves this course as Word documents and spreadsheets, delivered as a single .zip file. Double-click the .zip to open it and find everything sorted into folders. Keep this tab open until it finishes.</p>' +
  ...
  goBtn.addEventListener('click', async function () {
    ...
    // Zip-only by design. The export always delivers one .zip file, which
    // unzips into the same labeled subfolders. This avoids the browser folder
    // picker entirely: no permission prompts, no blocked-folder errors, and
    // identical behavior on every browser and every managed machine.
    var dirHandle = null;
